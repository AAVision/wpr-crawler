...
def main():
    parser = argparse.ArgumentParser(description="Run WR spider CLI (Optimized Scrapy)")
    parser.add_argument("--start-date", required=True, help="Start date (YYYY-MM-DD)")
    parser.add_argument("--end-date", required=True, help="End date (YYYY-MM-DD)")
    parser.add_argument("--body-id", help="Filter by specific body ID")
    parser.add_argument("--partition-months", type=int, default=1, help="Months per concurrent partition")
