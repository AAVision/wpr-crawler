...
from dagster_project.ops.transform_op import (
    transform_single_partition,
    consolidate_transform_results,
)
...
local_executor = multiprocess_executor.configured(
    {"max_concurrent": get_safe_concurrency_limit()}
)
